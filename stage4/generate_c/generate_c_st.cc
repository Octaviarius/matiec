...
void *visit(for_statement_c *symbol) {
  ...
  if (symbol->by_expression == NULL) {
    ...
    integer_oneval.const_value.int64_val.set(1);                    // set the stage3 anottation we need 
    integer_oneval.const_value.uint64_val.set(1);                    // set the stage3 anottation we need
